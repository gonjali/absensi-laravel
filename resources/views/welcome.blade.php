...
<div class="text-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <p class="text-gray-600 mb-4">Lihat rekap kehadiran karyawan per minggu dengan format yang mudah dibaca</p>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <h3 class="text-xl font-semibold text-gray-800 mb-2">Piket</h3>
            <p class="text-gray-600 mb-4">Kelola jadwal piket dan tugas karyawan</p>
